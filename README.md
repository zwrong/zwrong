...
[**Vibe-Trading**](https://github.com/HKUDS/Vibe-Trading) ⭐ 33.2K — Your personal AI trading agent. Multi-agent architecture for quantitative research, backtesting, risk management, and auto-trading — all via natural language.
