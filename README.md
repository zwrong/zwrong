...
[**Vibe-Trading**](https://github.com/HKUDS/Vibe-Trading) ⭐ 32.0K — Your personal AI trading agent. Multi-agent architecture for quantitative research, backtesting, risk management, and auto-trading — all via natural language.
