...
[**Vibe-Trading**](https://github.com/HKUDS/Vibe-Trading) ⭐ 33.6K — Your personal AI trading agent. Multi-agent architecture for quantitative research, backtesting, risk management, and auto-trading — all via natural language.
...
[**Kaku**](https://github.com/tw93/Kaku) ⭐ 5.9K — A fast, out-of-the-box terminal built for AI coding.
